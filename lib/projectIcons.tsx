...
/** Heroicons-style outline paths (24×24) */
const paths: Record<ProjectIcon, ReactNode> = {
  ...
  risk: (
    <>
      ...
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v3" />
    </>
  ),
  mobile: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 18.75h3"
    />
  ),
  llm: (
    <>
  ...
  cloudMl: (
    <>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 5.25 5.25 0 00-10.233-2.33A4.502 4.502 0 002.25 15z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M8.25 17.25v-3M12 17.25v-5.25M15.75 17.25v-1.5"
      />
    </>
  ),
  crypto: (
  ...
  analytics: (
    <>
      ...
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75v3.75m3-6.75v6.75m3-3v3.75" />
    </>
  ),
  lms: (
    <>
      ...
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 10.125L12 12.75l3.75-2.625" />
    </>
  ),
  school: (
    <>
...
export function ProjectIconSvg({ icon, className = "w-full h-full", title }: ProjectIconSvgProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
